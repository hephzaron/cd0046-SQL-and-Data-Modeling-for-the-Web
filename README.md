...
5. **Setup environment variables in .env file in the root directory**
```
SQLALCHEMY_DATABASE_URI = 'postgresql://{DATABASE_USERNAME}:{DATABASE_PASSWORD}@localhost:5432/{DATABASE_NAME}'
